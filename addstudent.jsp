...
String email=request.getParameter("email");
   ...
   String qry = "select max(id) as maxid from student";
            ...
            String ins = "insert into student values('"+id2+"','"+regno+"','"+name+"','"+gender+"','"+dob+"','"+depart+"','"+year+"','"+sem+"','"+ sclass + "','"+address+"','"+pnumber+"','"+email+"')";                     
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Register Student Details</h4>
                    ...
                    <table width="50%" border="0">
                      ...
                      <tr>
                        ...
                        <td>Gender</td>
                        <td>
                          <input name="gender" type="radio" value="male" class="form-check-input"/>
                          Male&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input name="gender" type="radio" value="female" class="form-check-input"/>
                          Female</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>Class</td>
                        <td><label>
                          <input name="class" type="text" id="class" class="form-control" required/>
                        </label></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      ...
                      <tr>
                        <td height="49">&nbsp;</td>
                        <td>Phone Number </td>
                        <td><input name="pnumber" type="text" id="pnumber"  class="form-control" maxlength="10" minlength="10" required/></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
