...
<html lang="en">
                    ...
                    <form id="form1" name="form1" method="post" action="">
                      <table width="30%" border="0">
                        ...
                        <tr>
                          ...
                          <td width="25%"><input name="btn" type="submit" id="btn" value="Submit" /></td>
                        </tr>
                      </table>
                      <p>&nbsp;</p>
  ...
  ResultSet rs0=stmt3.executeQuery("select * from feesmaster where department='"+dep+"' ORDER BY sem ASC");
		int s=0;
          ...
          <td><div align="center"><% out.print(rs0.getString("department"));%></div></td>
