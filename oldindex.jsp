...
{
$qry=mysql_query("select * from student where name='$uname' && regno='$password'");
$num=mysql_num_rows($qry);
if($num==1)
{
$rw=mysql_fetch_array($qry);
$_SESSION['un']=$password;
?>
<script language="javascript">
alert("Login Successfully..");
//alert("Your Account Not Approval..");
              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form  action="" method="post" name="foem1">
                  ...
                  <div class="mt-3">
					...
					<button type="submit" class="btn btn-primary btn-lg btn-block" name="btn">
