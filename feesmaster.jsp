...
String sem=request.getParameter("sem");
   ...
   String qry = "select max(id) as maxid from feesmaster";
            ...
            String ins = "insert into feesmaster values('"+id2+"','"+department+"','"+fees+"','"+sem+"')";                     
...
<script language="javascript" >
		alert("register Success\n");
                window.location.href = "feesmaster.jsp";
		</script>
                  ...
                  <div class="card-body">
					...
					<table width="50%" border="0">
                      <tr>
                        ...
                        <td width="33%"><input name="department" type="text" id="department" class="form-control" required/></td>
                        <td width="7%">&nbsp;</td>
                        <td width="7%">&nbsp;</td>
                      </tr>
                      <tr>
