...
<html lang="en">
                ...
                <div class="card">
                  <div class="card-body">
					...
					<table width="30%" border="0">
                      <tr>
                        <td width="15%">&nbsp;</td>
                        <td width="27%">Select Department : </td>
                        <td width="18%"><label>
  ...
  ResultSet rs0=stmt3.executeQuery("select * from student where dept='" + dept +"' ");
		int s=0;
                   ...
                   while(rs0.next())
			{
				...
				<%
                          ...
                          <td> <div align="center"> <% out.print(s);%><?php echo $i;?> </div></td>
                          <td> <div align="center"> <% out.print(rs0.getString("regno"));%>  </div></td>
                          <td> <div align="center"> <% out.print(rs0.getString("name"));%>  </div></td>
                          <td> <div align="center"> <% out.print(rs0.getString("dept"));%> </div></td>
                          <td> <div align="center"> <% out.print(rs0.getString("address"));%>  </div></td>
						  <td><div align="center"> <% out.print(rs0.getString("email"));%> </div></td>
                          <td></td>
						</tr>
